...
export const ServicesCarousel: React.FC = () => {
  ...
  const infiniteServicesData = Array.from(
    { length: COPY_COUNT },
    () => modifiedServicesData
  ).flat();
  ...
  const recenterIfNeeded = useCallback(() => {
    ...
    const normalizedIdx = getNormalizedIndex(
      currentIdx,
      totalServices
    );
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Every variety follows its own
                growing rhythm. Reserve your
                batch
                <br className="desktop-break" />
                and we'll harvest it when it's
                ready not when it's convenient.
              </Typography>
            </Box>
